...
//        }
        ...
        /* 如果使用快捷登陆，增加token参数 */
        if (!empty($_SESSION['open_token']))
        {
            $parameter['token'] = $_SESSION['open_token'];
        }
        ...
        //var_dump($parameter);
		//exit;
        $button = '<div style="text-align:center"><input type="button" onclick="window.open(\'https://www.alipay.com/cooperate/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5\')" value="'.$payment['pay_button'].'" class="tenpay pay_btn" /></div>';
