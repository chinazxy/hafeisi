...
class waptenpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $parameter = array(
            ...
            'return_url'           => return_url(basename(__FILE__, '.php')),  //提醒地址                         //IP
		...
		$button = '<a href="https://gw.tenpay.com/gateway/pay.htm?'.$param. '&sign='.$sign.'"> <div class="jiesuan pay_btn">财付通支付</div><a>'; 
