...
class yeepay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $def_url  = "<br/><form action='https://www.yeepay.com/app-merchant-proxy/node' method='post' target='_blank'  style='text-align:center;'>\n";
        ...
        $def_url .= "<input type='submit' class='tenpay' value='易宝支付'>";
        $def_url .= "</form>\n";
