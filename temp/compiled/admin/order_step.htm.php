...
?>
  <tr>
	...
	<a href="../<?php echo $this->_var['goods']['dingzhi_img']; ?>" target="_blank"><?php echo $this->_var['goods']['goods_name']; ?></a>
	...
	<?php else: ?>
	<td>[定制产品]暂无货号<input name="rec_id[]" type="hidden" value="<?php echo $this->_var['goods']['rec_id']; ?>" /></td>
	<?php endif; ?>
    <td><input name="goods_price[]" type="text" style="text-align:right" value="<?php echo $this->_var['goods']['goods_price']; ?>" size="10" /></td>
...
<?php if ($this->_var['step'] == 'fapiao'): ?>
<table border="0">
   <form action="order.php?act=step_post&step=<?php echo $this->_var['step']; ?>&order_id=<?php echo $this->_var['order_id']; ?>&step_act=<?php echo $this->_var['step_act']; ?>" method="post">
   <tr>
   <th align="left">发票形式</th>
   <td>
   <select name="inv_types">
   <option value="0" <?php if ($this->_var['order']['inv_types'] == 0): ?> selected="selected"<?php endif; ?>>Bolon 电子数据</option>
   <option value="1" <?php if ($this->_var['order']['inv_types'] == 1): ?> selected="selected"<?php endif; ?>>Bolon 标准发票</option>
   </select>
   </td>
   <td>发票收件电子邮箱：</td>
   <td><input type="text" name="inv_email" value="<?php echo $this->_var['order']['inv_email']; ?>"/></td>
   </tr>
   <tr>
    <th align="left">发票收件人姓：</th>
    <td><input type="text" name="inv_surname" value="<?php echo $this->_var['order']['inv_surname']; ?>"/></td>
	<td>发票收件人名：</td>
	<td><input type="text" name="inv_name" value="<?php echo $this->_var['order']['inv_name']; ?>"/></td>
  </tr>
     <tr>
    <th align="left">发票收件人手机号(电话)：</th>
    <td colspan="3"><input type="text" name="phone" value="<?php echo $this->_var['order']['phone']; ?>"/></td>
  </tr>
    <tr>
    <th align="left"><?php echo $this->_var['lang']['label_area']; ?></th>
	
    <td colspan="3">
	<select name="inv_province" id="selProvinces" onChange="region.changed(this, 2, 'selCities')">
        <option value="0"><?php echo $this->_var['lang']['select_please']; ?></option>
        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province');if (count($_from)):
    foreach ($_from AS $this->_var['province']):
?>
	   ...
	   <select name="inv_city" id="selCities" onchange="region.changed(this, 3, 'selDistricts')">
          <option value="0"><?php echo $this->_var['lang']['select_please']; ?></option>
          <!-- <?php $_from = $this->_var['city_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'city');if (count($_from)):
    foreach ($_from AS $this->_var['city']):
?> -->
		...
		<dd style="width:90px; float:right; margin:0 35% 0 0;">
        <select name="inv_district" id="selDistricts">
          <option value="0"><?php echo $this->_var['lang']['select_please']; ?></option>
          <!-- <?php $_from = $this->_var['district_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'district');if (count($_from)):
    foreach ($_from AS $this->_var['district']):
?> -->
  ...
  <tr>
    <th align="left">发票收件地址：</th>
    <td colspan="3"><input type="text" name="inv_address" value="<?php echo $this->_var['order']['inv_address']; ?>"/></td>
  </tr>
  <tr>
    <th align="left">收件地址房间号：</th>
    <td colspan="3"><input type="text" name="inv_room" value="<?php echo $this->_var['order']['inv_room']; ?>"/></td>
  </tr>
  <tr>
    <th align="left">发票收件单位名称：</th>
    <td colspan="3"><input type="text" name="inv_company_name" value="<?php echo $this->_var['order']['inv_company_name']; ?>"/></td>
  </tr>
  <tr>
    <th align="left">发票收件地址区号：</th>
    <td><input type="text" name="inv_quhao" value="<?php echo $this->_var['order']['inv_quhao']; ?>"/></td>
	<td>发票收件地址邮编：</td>
	<td><input type="text" name="inv_zipcode" value="<?php echo $this->_var['order']['inv_zipcode']; ?>"/></td>
  </tr>
  <tr><th></th>
...
<?php endif; ?>
<?php if ($this->_var['step'] == 'pay_dingzhigoods'): ?>
<table border="0" class="table_p">
   <form action="order.php?act=step_post&step=<?php echo $this->_var['step']; ?>&order_id=<?php echo $this->_var['order_id']; ?>&step_act=<?php echo $this->_var['step_act']; ?>" method="post">
...
?>
  ...
  <tr><td  class="t_tr">商品名称:</td><td colspan="3"><?php echo $this->_var['goods']['goods_name']; ?><input type="hidden" value="<?php echo $this->_var['goods']['rec_id']; ?>" name="rec_id[]"/></td></tr>

 
  <tr><td class="t_tr">主镜框编号:</td><td colspan="3"><?php echo $this->_var['goods']['qindan']['zjk_number']; ?><input type="hidden" value="<?php echo $this->_var['goods']['qindan']['zjk_number']; ?>" name="value[<?php echo $this->_var['key']; ?>][zjk_number]"/></td></tr>

  
 <?php if ($this->_var['goods']['qindan']['jk'] !== false): ?>
  <tr><td  class="t_tr">镜架:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['jk']; ?>" name="value[<?php echo $this->_var['key']; ?>][jk]" size="30"/></td></tr>
  <?php endif; ?>
 
  <?php if ($this->_var['goods']['qindan']['jp'] !== false): ?>
  <tr><td class="t_tr">镜片:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['jp']; ?>" name="value[<?php echo $this->_var['key']; ?>][jp]" size="30"/></td></tr>
  <?php endif; ?>
  
  <?php if ($this->_var['goods']['qindan']['jt'] !== false): ?>
  <tr><td  class="t_tr">镜腿左:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['jt']; ?>" name="value[<?php echo $this->_var['key']; ?>][jt]" size="30"/></td>
  </tr>
  <?php endif; ?>
  <?php if ($this->_var['goods']['qindan']['jt_r'] !== false): ?>
  <tr><td  class="t_tr">镜腿右:</td><td><input type="text" value="<?php echo $this->_var['goods']['qindan']['jt_r']; ?>" name="value[<?php echo $this->_var['key']; ?>][jt_r]" size="30"/></td>
  </tr>
  <?php endif; ?>
 <?php if ($this->_var['goods']['qindan']['jtt'] !== false): ?>
  <tr><td  class="t_tr">脚套左:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['jtt']; ?>" name="value[<?php echo $this->_var['key']; ?>][jtt]" size="30"/></td></tr>
  <?php endif; ?>
  <?php if ($this->_var['goods']['qindan']['jtt_r'] !== false): ?>
  <tr><td  class="t_tr">脚套右:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['jtt_r']; ?>" name="value[<?php echo $this->_var['key']; ?>][jtt_r]" size="30"/></td></tr>
  <?php endif; ?>
 
  <?php if ($this->_var['goods']['qindan']['sj'] !== false): ?>
  <tr><td  class="t_tr">前框饰件左:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['sj']; ?>" name="value[<?php echo $this->_var['key']; ?>][sj]" size="30"/></td></tr>
  <?php endif; ?>
  <?php if ($this->_var['goods']['qindan']['sj_r'] !== false): ?>
  <tr><td  class="t_tr">前框饰件右:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['sj_r']; ?>" name="value[<?php echo $this->_var['key']; ?>][sj_r]" size="30"/></td></tr>
  <?php endif; ?>
 
<?php if ($this->_var['goods']['qindan']['qk'] !== false): ?>
  <tr><td  class="t_tr">前框饰布左:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['qk']; ?>" name="value[<?php echo $this->_var['key']; ?>][qk]" size="30"/></td></tr>
  <?php endif; ?>
  <?php if ($this->_var['goods']['qindan']['qk_r'] !== false): ?>
  <tr><td  class="t_tr">前框饰布右:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['qk_r']; ?>" name="value[<?php echo $this->_var['key']; ?>][qk_r]" size="30"/></td></tr>
  <?php endif; ?>
   <tr><td class="t_tr">固定配件:</td><td colspan="3"> <?php $_from = $this->_var['goods']['qindan']['peijian']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'pjian');if (count($_from)):
    foreach ($_from AS $this->_var['pjian']):
?> <?php echo $this->_var['pjian']['number']; ?>&nbsp;&nbsp;<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?><?php if ($this->_var['goods']['qindan']['peijian'] == ''): ?>无<?php endif; ?><input type="hidden" name="peijian[]" value="<?php $_from = $this->_var['goods']['qindan']['peijian']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'pjian');if (count($_from)):
    foreach ($_from AS $this->_var['pjian']):
?><?php echo $this->_var['pjian']['number']; ?>,<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>"></td></tr>
  <tr><td colspan="4">	<div style="margin-left:20%">
                    尺寸：<?php if ($this->_var['goods']['dingzhi_attr_list_str']['size'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['size']; ?><?php else: ?>无<?php endif; ?><br/>
					镌刻：<?php if ($this->_var['goods']['dingzhi_attr_list_str']['type_w_text'] != "" || $this->_var['goods']['dingzhi_attr_list_str']['type_n_text'] != ""): ?> <?php if ($this->_var['goods']['dingzhi_attr_list_str']['type_w_text'] != ""): ?>镜腿外侧<?php if ($this->_var['goods']['dingzhi_attr_list_str']['type_w'] == 0): ?>左边<?php endif; ?> <?php if ($this->_var['goods']['dingzhi_attr_list_str']['type_w'] == 1): ?>右边<?php endif; ?><?php if ($this->_var['goods']['dingzhi_attr_list_str']['type_w'] == 2): ?>两边<?php endif; ?> 镌刻内容：<?php echo $this->_var['goods']['dingzhi_attr_list_str']['type_w_text']; ?><?php endif; ?> <?php if ($this->_var['goods']['dingzhi_attr_list_str']['type_n_text'] != ""): ?>镜腿内侧<?php if ($this->_var['goods']['dingzhi_attr_list_str']['type_n'] == 0): ?>左边<?php endif; ?> <?php if ($this->_var['goods']['dingzhi_attr_list_str']['type_n'] == 1): ?>右边<?php endif; ?><?php if ($this->_var['goods']['dingzhi_attr_list_str']['type_n'] == 2): ?>两边<?php endif; ?> 镌刻内容：<?php echo $this->_var['goods']['dingzhi_attr_list_str']['type_n_text']; ?><?php endif; ?> <?php else: ?> 无 <?php endif; ?><br/>
					<?php if ($this->_var['goods']['dingzhi_attr_list_str']['jp_type'] == 1): ?><span><strong>处方信息</strong></span><br/>
                    左眼：<?php if ($this->_var['goods']['dingzhi_attr_list_str']['l_eye_s'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['l_eye_s']; ?><?php else: ?>无<?php endif; ?>/s <?php if ($this->_var['goods']['dingzhi_attr_list_str']['l_eye_c'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['l_eye_c']; ?><?php else: ?>无<?php endif; ?>/c <?php if ($this->_var['goods']['dingzhi_attr_list_str']['l_eye_a'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['l_eye_a']; ?><?php else: ?>无<?php endif; ?>/A <?php if ($this->_var['goods']['dingzhi_attr_list_str']['l_eye_t'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['l_eye_t']; ?><?php else: ?>无<?php endif; ?>/MPD&nbsp;<br/>
					右眼：<?php if ($this->_var['goods']['dingzhi_attr_list_str']['r_eye_s'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['r_eye_s']; ?><?php else: ?>无<?php endif; ?>/s <?php if ($this->_var['goods']['dingzhi_attr_list_str']['r_eye_c'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['r_eye_c']; ?><?php else: ?>无<?php endif; ?>/c <?php if ($this->_var['goods']['dingzhi_attr_list_str']['r_eye_a'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['r_eye_a']; ?><?php else: ?>无<?php endif; ?>/A <?php if ($this->_var['goods']['dingzhi_attr_list_str']['r_eye_t'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['r_eye_t']; ?><?php else: ?>无<?php endif; ?>/MPD&nbsp;<br/>
					瞳距：<?php if ($this->_var['goods']['dingzhi_attr_list_str']['pd_eye_t'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['pd_eye_t']; ?><?php else: ?>无<?php endif; ?>/FD<br/><?php endif; ?>
					<span><strong>镜盒信息</strong></span><br/>
					镜盒系列：<?php if ($this->_var['goods']['dingzhi_attr_list_str']['jh'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['jh']; ?> <?php else: ?> 默认 <?php endif; ?>&nbsp;
                    镜盒定制文字一：<?php if ($this->_var['goods']['dingzhi_attr_list_str']['jh_line_one'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['jh_line_one']; ?> <?php else: ?> 无文字 <?php endif; ?>&nbsp;
					镜盒定制文字二：<?php if ($this->_var['goods']['dingzhi_attr_list_str']['jh_line_two'] != ""): ?><?php echo $this->_var['goods']['dingzhi_attr_list_str']['jh_line_two']; ?> <?php else: ?> 无文字 <?php endif; ?>&nbsp;
				...
				<?php if ($this->_var['goods']['qindan']['cz'] !== false): ?>
  <tr><td  class="t_tr">镜盒材质:</td><td colspan="3"><input type="text" value="<?php echo $this->_var['goods']['qindan']['cz']; ?>" name="value[<?php echo $this->_var['key']; ?>][cz]" size="30"/></td></tr>
  <?php endif; ?>
 <tr><td colspan="4" style="height:10px;background-color:#DDEEF2"></td></tr>
