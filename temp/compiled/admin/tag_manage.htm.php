...
?>
  <tr>
    <td align="center"><span><input name="checkboxes[]" type="checkbox" value="<?php echo $this->_var['tag']['tag_id']; ?>"><?php echo $this->_var['tag']['tag_id']; ?></span></td>
    <td align="center" class="first-cell"><span onclick="javascript:listTable.edit(this, 'edit_tag_name', <?php echo $this->_var['tag']['tag_id']; ?>)"><?php echo $this->_var['tag']['tag_words']; ?></span></td>
    <td align="center"><span><?php echo $this->_var['tag']['user_name']; ?></span></td>
    <td align="center"><span><a href="../goods.php?id=<?php echo $this->_var['tag']['goods_id']; ?>" target="_blank"><?php echo $this->_var['tag']['goods_name']; ?></a></span></td>
    <td align="center">
      <span>
