...
?>
    <tr align="center">
      ...
      <td><?php echo $this->_var['list']['addtime']; ?></td>
	      <td align="right"><span>
      <a href="videoim.php?act=edit&id=<?php echo $this->_var['list']['id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
...
function getDownUrl()
{
  ...
  { 
    if (aTags[i].href.indexOf('download') >= 0)
    {
      ...
      aTags[i].href = "videoim.php?act=download&start_date=" + listTable.filter['start_date'] + "&end_date=" + listTable.filter['end_date'];
    }
  }
}
//-->
