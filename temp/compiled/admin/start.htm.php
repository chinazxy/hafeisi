...
<br />
<!-- trader order statistics -->
<div class="list-div">
<table cellspacing='1' cellpadding='3'>
  <tr>
    <th colspan="4" class="group-title">加盟商订单统计信息</th>
  </tr>
  <tr>
    <td width="20%"><a href="order.php?act=trader_order_list&state=1">未处理订单</a></td>
    <td width="30%"><strong style="color: red"><?php echo $this->_var['order']['trader_unconfirmed']; ?></strong></td>
    <td width="20%"><a href="order.php?act=trader_order_list&state=2">已响应订单</a></td>
    <td width="30%"><strong style="color: blue"><?php echo $this->_var['order']['trader_repone']; ?></strong></td>
  </tr>

  <tr>
    <td><a href="order.php?act=trader_order_list&state=3">已发货订单</a></td>
    <td><strong><?php echo $this->_var['order']['trader_delivery']; ?></strong></td>
