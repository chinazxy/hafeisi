...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
        ...
        class="tab-back" id="mix-tab"><?php echo $this->_var['lang']['tab_mix']; ?></span>
		...
		<!--<span class="tab-back" id="gallery-tab"><?php echo $this->_var['lang']['tab_gallery']; ?></span><span
        class="tab-back" id="linkgoods-tab">搭配关联商品</span>--><?php if ($this->_var['code'] == ''): ?><span
      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" onsubmit="return validate();">
        ...
        <table width="90%" id="general-table" align="center">
          <tr>
            ...
            <tr>
                <td class="label">商品英文名：</td>
                <td><input type="text" name="goods_enname" value="<?php echo htmlspecialchars($this->_var['goods']['goods_enname']); ?>"/></td>
            </tr>
            <tr>
                <td class="label">商品副标：</td>
                <td><input type="text" name="sub_title" value="<?php echo $this->_var['goods']['sub_title']; ?>"/></td>
            </tr>
            <tr>
                <td class="label">信购产品ID：</td>
                <td><input type="text" name="xingou_id" value="<?php echo $this->_var['goods']['xingou_id']; ?>"/></td>
            </tr>
          <tr>
            <td class="label">
		  ...
		  <tr style="display:none;"> 
		    <td class="label">Efast Sku码</td>
			<td><input type="" name="goods_sku" value="<?php echo $this->_var['goods']['goods_sku']; ?>" />
		    <span class="notice-span">用于Kfast系统关联SKU码,用于调取接口信息用. </span>
		</td>
		  </tr>
          <tr>
...
?>
          ...
          <?php endif; ?>
       		  <tr> 
		    <td class="label">美元价格：</td>
			<td><input type="" name="usa_price" value="<?php echo $this->_var['goods']['usa_price']; ?>" />
	 
		</td>
		  </tr>
            <tr>
                <td class="label">使用说明：</td>
                <td>
                    <textarea name="instructions" id="" cols="60" rows="5"><?php echo $this->_var['goods']['instructions']; ?></textarea>
                </td>
            </tr>
            <tr>
                <td class="label">产品描述：</td>
                <td>
                    <textarea name="description" id="" cols="60" rows="5"><?php echo $this->_var['goods']['description']; ?></textarea>
                </td>
            </tr>
          <!--商品优惠价格-->
          <tr  style="display:none">
...
?>
          ...
          <tr id="promote_4" style="display:none;">
            ...
            <td id="promote_6">
		     ...
		     <tr>
            <td class="label">天猫购买URL:</td>
            <td><input type="text" name="tmail_url" value="<?php echo $this->_var['goods']['tmail_url']; ?>" size="20" />
           <!--<input type="button" value="<?php echo $this->_var['lang']['compute_by_mp']; ?>" onclick="marketPriceSetted()" />-->
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <?php endif; ?>
			   <span id="noticeUserPrice" class="notice-span" style="display:block">(图片大小 宽800px*高800px)</span>
          ...
          <tr>
            <td class="label">商品背景图  : </td>
            <td>
              <input type="file" name="back_goods_img" size="35" />
              <?php if ($this->_var['goods']['back_goods_img']): ?>
                <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['back_goods_img']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a>
              <?php else: ?>
                <img src="images/no.gif" />
              <?php endif; ?>
         <span id="" class="notice-span" style="display:block">(图片大小 宽233px*高520px)</span>
              <br /><!--<input type="text" size="40" value="<?php echo $this->_var['lang']['lab_picture_url']; ?>" style="color:#aaa;" onfocus="if (this.value == '<?php echo $this->_var['lang']['lab_picture_url']; ?>'){this.value='http://';this.style.color='#000';}" name="goods_img_url"/>
           --></td>
          </tr>
            <tr>
                <td class="label">手机商品详情图  : </td>
                <td>
                    <input type="file" name="mobile_detail_img" size="35" />
                    <?php if ($this->_var['goods']['mobile_detail_img']): ?>
                    <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['mobile_detail_img']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a>
                    <?php else: ?>
                    <img src="images/no.gif" />
                    <?php endif; ?>
                    <span id="" class="notice-span" style="display:block">(图片大小 宽233px*高520px)</span>
          ...
          <tr id="auto_thumb_1">
            ...
            <td id="auto_thumb_3">
              ...
              <?php if ($this->_var['goods']['goods_thumb']): ?>
                <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['goods_thumb']; ?>" target="_blank"><img src="images/yes.gif" border="0" /><img src="../<?php echo $this->_var['goods']['goods_thumb']; ?>" /></a>
              ...
              <br /><label for="auto_thumb" style="display:none;"><input type="checkbox" id="auto_thumb" name="auto_thumb" checked="true" value="1" onclick="handleAutoThumb(this.checked)" /><?php echo $this->_var['lang']['auto_thumb']; ?></label><?php endif; ?>
            </td>
          </tr>
        </table>
...
<!--            <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['code'] != '' || $this->_var['goods']['_attribute'] != ''): ?>readonly="readonly"<?php endif; ?> /><br />-->
          ...
          <tr>
            ...
            <td><input type="checkbox" name="is_best" value="1" <?php if ($this->_var['goods']['is_best']): ?>checked="checked"<?php endif; ?> />精选<input type="checkbox" name="is_new" value="1" <?php if ($this->_var['goods']['is_new']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_new']; ?> <input type="checkbox" name="is_hot" value="1" <?php if ($this->_var['goods']['is_hot']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_hot']; ?><input type="checkbox" name="is_discount" value="1" <?php if ($this->_var['goods']['is_discount']): ?> checked="checked"<?php endif; ?> />折扣</td>
          </tr>
          <tr id="alone_sale_1">
          ...
          <tr>
            ...
            <td><input type="text" name="keywords" value="<?php echo htmlspecialchars($this->_var['goods']['keywords']); ?>" size="40" /> <?php echo $this->_var['lang']['notice_keywords']; ?></td>
		      ...
		      <tr style="display:none;">
            <td class="label">尺寸描述（中）:</td>
                 <td><?php echo $this->_var['goods_size_des']; ?></td>
          </tr>
		  
		        <tr style="display:none;">
            <td class="label">尺寸描述（英）:</td>
                 <td><?php echo $this->_var['goods_size_endes']; ?></td>
          </tr>
		  
		          <tr style="display:none;">
            <td class="label">产品材质（中）:</td>
                 <td><?php echo $this->_var['goods_glass_des']; ?></td>
          </tr>
		  
		          <tr style="display:none;">
            <td class="label">产品材质（英）:</td>
                 <td><?php echo $this->_var['goods_glass_endes']; ?></td>
          </tr>
		  
		            <tr>
            <td class="label">设计灵感（中）:</td>
                 <td><?php echo $this->_var['goods_good_des']; ?></td>
          </tr>
		  
		          <tr>
            <td class="label">设计灵感（英）:</td>
                 <td><?php echo $this->_var['goods_good_endes']; ?></td>
          </tr>
		    <!--     <tr>
            <td class="label">顾客服务:</td>
                    <td><?php echo $this->_var['goods_xijie_FCK']; ?></td>
          </tr>
	
      
		  
		     <tr>
            <td class="label">尺码指导:</td>
            <td><?php echo $this->_var['goods_size_FCK']; ?></td>
          </tr>
		  
		     <tr>
            <td class="label">面料:</td>
                <td><?php echo $this->_var['goods_material_FCK']; ?></td>
          </tr>
		       <tr>
            <td class="label">配送&退货:</td>
                <td><?php echo $this->_var['otherinfo_FCK']; ?></td>
          </tr>-->
          <tr>
            <td class="label">
...
?>
  ...
  function DeleteColor(id){
     ...
     if(confirm("您确定要删除该记录吗?")){
	   ...
	   Ajax.call('goods.php?is_ajax=1&act=drop_color', "color_id="+id, dropColorResponse, "GET", "JSON");
    ...
    function dropColorResponse(result)
  {
      if (result.error == 0)
      {
          document.getElementById('color-table-'+ result.content).style.display = 'none';
      }
  }
...
?>
  ...
  */
  ...
  function selectVal(obj){
   ...
   var coloval = obj.item(sindex).getAttribute("colorval"); 
    getNextSibling(getNextSibling(getNextSibling(obj))).setAttribute("value",coloval);
    getNextSibling(obj).item(sindex).selected=true;
  }
  
    function selectOth(obj){
   var sindex=obj.selectedIndex;
   //var coloval = obj.item(sindex).getAttribute("colorval"); 
  // getNextSibling(getNextSibling(getNextSibling(obj))).setAttribute("value",coloval);
    getNextSibling(obj).item(sindex).selected=true;
