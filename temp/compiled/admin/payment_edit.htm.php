...
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <tr>
    ...
    <td><textarea name="pay_desc" cols="60" rows="8"><?php echo htmlspecialchars($this->_var['pay']['pay_desc']); ?></textarea></td>
      ...
      <tr>
      <td class="label">支付图标</td>
    <td><input type="file" name="ico_pay" />
	  <?php if ($this->_var['pay']['pay_icon'] != ''): ?>
	  
     <img src="../<?php echo $this->_var['pay']['pay_icon']; ?>" />
	 
	  
	  <?php endif; ?>
	  <input type="hidden" name="ico_pay_h" value="<?php echo $this->_var['pay']['pay_icon']; ?>" />
    </td>
