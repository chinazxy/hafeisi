...
<table cellpadding="3" cellspacing="1">
  <tr>
	...
	<th><a href="javascript:listTable.sort('goods_thumb'); ">产品图</th>
	...
	<th><a href="javascript:listTable.sort('is_discount'); ">折扣</a></th>
...
?>
  <tr>
    ...
    <td><span onclick="listTable.edit(this, 'edit_goods_sn', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['goods_sn']; ?></span></td>
	 <td><span onclick="listTable.edit(this, 'edit_goods_thumb', <?php echo $this->_var['goods']['goods_id']; ?>)"><img src="../<?php echo $this->_var['goods']['goods_thumb']; ?>"/></span></td>
    ...
    <td align="center"><img src="images/<?php if ($this->_var['goods']['is_hot']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_hot', <?php echo $this->_var['goods']['goods_id']; ?>)" /></td>
	 <td align="center"><img src="images/<?php if ($this->_var['goods']['is_discount']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_discount', <?php echo $this->_var['goods']['goods_id']; ?>)" /></td>
    ...
    <td align="center">
      ...
      <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['goods']['goods_id']; ?>, '<?php echo $this->_var['lang']['trash_goods_confirm']; ?>')" title="<?php echo $this->_var['lang']['trash']; ?>"><img src="images/icon_trash.gif" width="16" height="16" border="0" /></a>
	    <a href="goods_p.php?id=<?php echo $this->_var['goods']['goods_id']; ?>&act=edit" title="产品角度图添加"><img src="images/pictures.png" width="16" height="16" border="0" /></a>
