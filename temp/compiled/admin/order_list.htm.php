...
?>
  <tr>
    ...
    <td align="center" valign="top"  nowrap="nowrap">
     ...
     <?php endif; ?>
	 <?php if ($this->_var['order']['extension_code'] == 'dingzhi' && $this->_var['order']['pay_status'] == 2): ?>
    &nbsp;&nbsp;&nbsp;&nbsp; <a href="../pay_dingzhigoods.php?order_sn=<?php echo $this->_var['order']['order_sn']; ?>" target="_blank" onclick="">售货清单</a>
	 <?php endif; ?>
