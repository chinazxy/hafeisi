...
<table cellspacing='1' cellpadding='3' id='list-table'>
  <tr>
    ...
    <th><a href="javascript:listTable.sort('article_type'); ">是否帮助栏显示</a></th>
    <th><a href="javascript:listTable.sort('is_open'); "><?php echo $this->_var['lang']['is_open']; ?></a><?php echo $this->_var['sort_is_open']; ?></th>
	    <th><a href="javascript:listTable.sort('is_show'); ">首页显示</a></th>
		    <th>排序</th>
...
?>
  <tr>
    ...
    <img src="images/<?php if ($this->_var['list']['article_type'] == 1): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'article_type', <?php echo $this->_var['list']['article_id']; ?>)" /></span></td>
    ...
    <img src="images/<?php if ($this->_var['list']['is_open'] == 1): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_show', <?php echo $this->_var['list']['article_id']; ?>)" /></span><?php else: ?><img src="images/yes.gif" alt="yes" /><?php endif; ?></td>
	  <td align="center"><span>
    <img src="images/<?php if ($this->_var['list']['is_show'] == 1): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'is_show', <?php echo $this->_var['list']['article_id']; ?>)" /></span></td>
