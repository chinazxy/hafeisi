...
function deletImg(id){
  ...
  if(confirm("您确定要删除该图片吗?")){
    ...
    location.href="desufb.php?act=remove&id="+id;
...
?>
    <tr align="center">
      ...
      <td><?php echo $this->_var['list']['addtime']; ?></td>
	      <td align="right"><span>
      <a href="desufb.php?act=edit&id=<?php echo $this->_var['list']['id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
      <a href="javascript:deletImg(<?php echo $this->_var['list']['id']; ?>)" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="16" width="16" /></a></span>
    </td>
    </tr>
  <?php endforeach; else: ?>
...
function getDownUrl()
{
  ...
  { 
    if (aTags[i].href.indexOf('download') >= 0)
    {
      ...
      aTags[i].href = "desufb.php?act=download&start_date=" + listTable.filter['start_date'] + "&end_date=" + listTable.filter['end_date'];
    }
  }
}
