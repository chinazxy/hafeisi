...
function deletImg(id){
  ...
  if(confirm("您确定要删除该图片吗?")){
    ...
    location.href="gonyigg.php?act=remove&id="+id;
...
?>
    <tr align="center">
      ...
      <td><?php echo $this->_var['list']['addtime']; ?></td>
	      <td align="right"><span>
      <a href="gonyigg.php?act=edit&id=<?php echo $this->_var['list']['id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
