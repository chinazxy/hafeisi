...
?>
	...
	<td align="center"><?php echo $this->_var['list']['title']; ?></td>
      <td align="center"><?php echo $this->_var['list']['entitle']; ?></td>
      <td align="center"><?php if ($this->_var['list']['images_t'] != ''): ?><a href="../<?php echo $this->_var['list']['images_t']; ?>" target="_blank"><img src="../<?php echo $this->_var['list']['images_t']; ?>" /><?php else: ?>暂无图片!<?php endif; ?></td>
      ...
      <a href="menshop.php?act=edit&id=<?php echo $this->_var['list']['id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
