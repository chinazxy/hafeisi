...
?>
  ...
  <tr>
   ...
   <?php $_from = $this->_var['order']['refund_goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
    
	<tr>
                <td align="left" width="35%"><a href="../<?php echo $this->_var['goods']['url']; ?>" target="_blank"><img src="../<?php echo $this->_var['goods']['goods_thumb']; ?>" width="40" height="40" /><?php echo $this->_var['goods']['goods_name']; ?></a>(<?php echo $this->_var['goods']['goods_number']; ?>件)</td>
                <td align="left" width="5">	<?php if ($this->_var['goods']['refund_status'] == 1): ?><span style="color:red">退货处理中</span><?php endif; ?>
		<?php if ($this->_var['goods']['refund_status'] == 2): ?><span style="color:red">退款成功</span><?php endif; ?>
		<?php if ($this->_var['goods']['refund_status'] == 3): ?><span style="color:red">退款失败</span><?php endif; ?></td>
                <td align="left" width="5"><?php echo $this->_var['goods']['refund_add_time_fmt']; ?></td>
                <td align="left" width="5"><?php echo $this->_var['goods']['refund_confirm_time_fmt']; ?></td>
				<td align="left" width="35"><?php echo $this->_var['goods']['refund_reason']; ?><br />
				<?php echo $this->_var['goods']['refund_desc']; ?><br />
				<?php if ($this->_var['goods']['refund_pic1']): ?><a href="<?php echo $this->_var['goods']['refund_pic1']; ?>" target="_blank">图片1</a>&nbsp;<?php endif; ?>
				<?php if ($this->_var['goods']['refund_pic2']): ?><a href="<?php echo $this->_var['goods']['refund_pic2']; ?>" target="_blank">图片2</a>&nbsp;<?php endif; ?>
				<?php if ($this->_var['goods']['refund_pic3']): ?><a href="<?php echo $this->_var['goods']['refund_pic3']; ?>" target="_blank">图片3</a><?php endif; ?>
				</td>
				<td align="left" width="10"><?php echo $this->_var['goods']['refund_money']; ?></td>
				<td align="left" width="5"><?php if ($this->_var['goods']['refund_status'] == 1): ?><a href="javascript:confirm_redirect('同意该申请', 'order.php?act=confirm_refund&rec_id=<?php echo $this->_var['goods']['rec_id']; ?>&agree=1');">同意</a>&nbsp;
				<a href="javascript:confirm_redirect('确认要拒绝该申请么', 'order.php?act=confirm_refund&rec_id=<?php echo $this->_var['goods']['rec_id']; ?>&agree=0');">拒绝</a><?php endif; ?></td>
              </tr>
