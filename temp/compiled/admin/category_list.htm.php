...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
	...
	<td width="10%"><?php echo $this->_var['cat']['cat_enname']; ?></td>
    ...
    <td width="24%" align="center">
	  ...
	  <?php $_from = $this->_var['cat']['cat_addtypes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'vo');if (count($_from)):
    foreach ($_from AS $this->_var['vo']):
?>
	  <?php if ($this->_var['vo'] == 1): ?>
	   <a href="cat_image.php?id=<?php echo $this->_var['cat']['cat_id']; ?>&type=1&act=add">形像图集</a> |
	   <?php endif; ?>
	    <?php if ($this->_var['vo'] == 2): ?>
	   <a href="cat_video.php?id=<?php echo $this->_var['cat']['cat_id']; ?>&type=2&act=add">视频大片</a> |
	   <?php endif; ?>
