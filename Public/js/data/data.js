var $dp, WdatePicker; (function() {
	...
	_ = J();
	if ($.$wdate) K(_ + "./Public/js/data/skin/WdatePicker.css");
	var L;
	if (T.$dp) {
		try {
			T.$dp.$("my97")
	...
	function I(G, A) {
		...
		if (!$dp.dd || $dp.eCont || ($dp.lang && $dp.realLang && $dp.realLang.name != $dp.lang)) {
			...
			if ($.$dpPath == "") D(_);
			var B = "<iframe src=\"" + $.$dpPath + "./Public/js/data/My97DatePicker.htm\" frameborder=\"0\" border=\"0\" scrolling=\"no\"></iframe>";
			if ($dp.eCont) {
