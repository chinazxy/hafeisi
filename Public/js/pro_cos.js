$(document).ready(function() {
	...
	function ShowCaseDetailImage(obj) {
		...
		obj.parent().css("background", "url(" + obj.attr("src") + ") no-repeat scroll center center rgba(0, 0, 0, 0)");
      	obj.parent().css({"-moz-background-size":"100%","-o-background-size":"100%", "background-size":"100%"});
		//obj.parent().css({"-webkit-background-size":"100%","-o-background-size":"100%"});
