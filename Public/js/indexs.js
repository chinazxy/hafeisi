...
function webInit() {
	...
	pagesArr.push(page5_action),
	 ...
	 $(".appreciate_04_ul").css("width",$(".appreciate_04_ul li").length*windowWidth);
	  $(".appreciate_04_ul").css("height",windowHeight+"px");
	 $(".appreciate_04_ul li").css({"width":windowWidth+"px","height":windowHeight+"px"});
     gotoPage(step);
