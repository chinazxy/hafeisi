...
$_LANG['jh'] = '镜盒';
$_LANG['cz'] = '材质';
$_LANG['dingzhi_msg'] = '%s处于缺货状态，收货时间延长至<span class="sf_day">%d</span>天';
$_LANG['dingzhi_default_msg']="预计交货时间<span class='sf_day'>%d</span>天";


/*加入购物车*/
$_LANG['l_add_cart']='加入购物车';
$_LANG['l_sina']='新浪';
$_LANG['l_weixin']='微信';
$_LANG['l_weibo']='腾讯微博';
$_LANG['l_qqzone']='qq空间';
$_LANG['l_glass']='镜片';
$_LANG['l_frame']='镜框';
$_LANG['l_no_goods']='暂无商品';
$_LANG['l_related_products']='相关产品';
$_LANG['l_history_products']='曾经浏览过的产品';
$_LANG['l_my_bolon']='我的BOLON';

$_LANG['l_immediately']='立即填写详细会员信息享受专属礼遇。';
$_LANG['l_regeist_service']='注册用户专享服务';
$_LANG['l_newuser']='新用户';
$_LANG['l_account_info']='通过“我的帐户”查看个人信息';
$_LANG['l_save_l_c']='使用收藏夹保存心仪商品';
$_LANG['l_c_s_p']='完成购物流程更快捷';
$_LANG['l_registered']='注册';
$_LANG['l_e_y_e_a']='输入您的电子邮箱及密码登录“我的帐户”';
$_LANG['l_p_c_e_m']='请检查您的电子邮件和密码，如果您在正确的，以及它是否是在该国的注册表。';
$_LANG['l_you_forgot_your_password']='您忘记了密码?';
$_LANG['l_email']='电子邮件地址';

$_LANG['l_password']='密码';
$_LANG['l_remember_me']='下次请记住我的信息';
$_LANG['l_weibo_login']='微博账号登录';
$_LANG['l_qq_login']='QQ账号登录';
$_LANG['l_login']='登录';
$_LANG['l_have_you_forget_pass']='你忘记你的密码了吗？';
$_LANG['L_email_reset_pass']='请输入登录我的账户时所使用的电子邮件地址，您将收到一封电子邮件，其中含有修改密码的链接 ';
$_LANG['l_e_mail']='邮箱';
$_LANG['l_send']='发送';
$_LANG['l_bank']='返回';
$_LANG['l_cart_empty']='您的购物车中没有商品';
$_LANG['l_have_account']='有账号了吗？';
$_LANG['l_view_shopping_cart']='查看购物车';
$_LANG['l_checkout_immediately']='立即结账';
$_LANG['l_log_in']='登录';
$_LANG['l_not_account']='我没有注册任何帐户。';
$_LANG['l_create_person_account']='创造更多的专属特权和丰富经验的个人帐户';
$_LANG['l_create_my_account']='创建暴龙账号';
$_LANG['l_member_login']='会员登录';
$_LANG['l_i_have_account']='我已有一个账户';
$_LANG['l_forget_pass']='忘记密码?';
$_LANG['l_register']='注册';
$_LANG['l_now_register']='现在注册';
$_LANG['l_exclusive_membership_services']='专属会员服务';
$_LANG['l_you_can']='你可以';
$_LANG['l_receive_our_newsletter']='收到我们的时事通讯';
$_LANG['l_save_your_favorite_products']='保存你最喜欢的产品';
$_LANG['l_more_convenient_payment_process']='更便捷的支付流程';
$_LANG['l_manage_your_order_and_return']='管理你的订单和退货';
$_LANG['l_confirm_password']='确认密码';
$_LANG['l_required']="必填";
$_LANG['l_immediate_registration']='立即登记';
$_LANG['l_favorite_brand']='请选择你喜欢的品牌，获得对当前品牌最新信。';
$_LANG['l_all_brand']='所有品牌';
$_LANG['l_write_read']='我已阅读并同意';
$_LANG['l_bolon_agree']='BOLON会员注册协议';
$_LANG['l_confirm']='确定';
$_LANG['l_filter']='筛选';
$_LANG['l_reset']="重置";
$_LANG['l_search']='搜索';
...
$_LANG['l_submit']="提交";
$_LANG['l_more']="更多";
$_LANG['l_design_inspiration']="设计灵感";
$_LANG['l_size_specification']="尺寸规格";
$_LANG['l_product_material']="产品材质";

$_LANG['l_frame_material']="镜框材质";
$_LANG['l_glass_material']="镜片采用";
$_LANG['l_size']="长度";
$_LANG['l_brand']="品牌";
$_LANG['l_technology']="独特卡槽工艺";
$_LANG['l_color']="颜色：";
$_LANG['l_address']="厦门市思明区南投路1号1101单元";
$_LANG['l_company']="厦门愛亦锐光学有限公司";
$_LANG['l_telephone']="电话：";
$_LANG['l_stoneshop']="BOLON店铺";
$_LANG['l_boutique']="按精品店查询";

$_LANG['l_no_found']="很遗憾，没有找到符合你搜索要求的产品!";
$_LANG['l_together_searches']="共搜索到";
$_LANG['l_product_c']="产品";
?>