...
$_LANG['cfg_desc']['rate'] = '输入规则按照和美元的汇率进行出入Us,EURP,BriishPound,China,Austriliar'; 
...
$_LANG['cfg_name']['dingzhi_day'] = '定制产品默认配送时间';
$_LANG['cfg_name']['dingzhi_title'] = '定制首页标题(中)';
$_LANG['cfg_name']['dingzhi_entitle'] = '定制首页标题(英)';
$_LANG['cfg_name']['dingzhi_content'] = '定制首页描述(中)';
$_LANG['cfg_name']['dingzhi_encontent'] = '定制首页描述(英)';
$_LANG['cfg_name']['md5str'] = 'Ajax验证加密串';
