...
/* 会员密码找回 */
$_LANG['username_and_email'] = '请输入您注册的手机号和注册时填写的电子邮件地址。';
$_LANG['enter_new_password'] = '请输入您的新密码';
$_LANG['username_no_email'] = '您填写的手机号与电子邮件地址不匹配，请重新输入！';
...
$_LANG['username_not_match_email'] = '手机号与电子邮件地址不匹配，请重新输入！';
$_LANG['get_question_username'] = '请输入您注册的手机号以取得您的密码提示问题。';
...
//JS语言项
$_LANG['password_js']['user_name_empty'] = '请输入您的手机号！';
...
$_LANG['qq_reg'] = 'QQ关联注册';
$_LANG['sina_reg'] = '新浪关联注册';
$_LANG['qq_bind_account'] = 'QQ账号关联绑定';
$_LANG['sina_bind_account'] = '新浪账号关联绑定';

$_LANG['relate_login']='关联登录失败';
$_LANG['l_has_login']='你已经登陆系统，无需重新注册';
$_LANG['l_login']='登录';
$_LANG['l_closeed_register']='暂时关闭注册功能';
$_LANG['l_author']='授权失败';
