...
$_LANG['qq_reg'] = 'QQ Association Registration';
$_LANG['sina_reg'] = 'Sina Association Registration';
$_LANG['qq_bind_account'] = 'QQ Account Associated Binding ';
$_LANG['sina_bind_account'] = 'Sina Account Associated Binding';
/*关联登录失败*/
$_LANG['relate_login'] = 'Associated login failed';
/*你已经登陆系统，无需重新注册*/
$_LANG['l_has_login']='You have landed on the system, no need to re register';
/*登录*/
$_LANG['l_login']='Login';
/*暂时关闭注册功能*/
$_LANG['l_closeed_register']='Temporarily shut down the registration function';
/*授权失败*/
$_LANG['l_author']='Authorization failed';
