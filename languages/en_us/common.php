...
/*加入购物车*/
$_LANG['l_add_cart']='shopping cart';
$_LANG['l_sina']='Sina';
$_LANG['l_weixin']='Weixin';
$_LANG['l_weibo']='Tencent Weibo';
$_LANG['l_qqzone']='QQ Zone';
$_LANG['l_glass']='GLASS';
$_LANG['l_frame']='FRAME';
/*暂无商品*/
$_LANG['l_no_goods']='No Goods';
/*相关产品*/
$_LANG['l_related_products']='Related Products';
/*曾经浏览过的产品*/
$_LANG['l_history_products']='Browse through the product';

$_LANG['l_my_bolon']='My Bolon';
/*立即填写会员信息的细节，享受专属的特权*/
$_LANG['l_immediately']='Immediately fill out the details of membership information enjoy exclusive privileges.';
/*注册用户专属服务*/
$_LANG['l_regeist_service']='Registered users exclusive service';
/*通过我的帐号查看个人信息*/
$_LANG['l_account_info']='View personal information through my account.';
/*保存您最喜爱的产品与收藏*/
$_LANG['l_save_l_c']='Save your favorite products with favorites';
/*完整的购物过程更加迅速*/
$_LANG['l_c_s_p']='Complete shopping process more quickly';
/*注册*/
$_LANG['l_registered']='Registered';
/*输入要登录到我的帐户的电子邮件地址和密码*/
$_LANG['l_e_y_e_a']='Enter your email address and password to log in to my account';
/*请检查您的电子邮件和密码，如果您在正确的，以及它是否是在该国的注册表。*/
$_LANG['l_p_c_e_m']='Please check your email and password if you are in the right, and whether it is in the country of the registry.';
$_LANG['l_you_forgot_your_password']='You forgot your password';
$_LANG['l_email']='Email';
$_LANG['l_password']='Password';
$_LANG['l_remember_me']='Next time, please remember me.';
$_LANG['l_weibo_login']='Sina account login';
$_LANG['l_qq_login']='QQ account login';
$_LANG['l_login']='Login';
/*你忘记你的密码了吗？*/
$_LANG['l_have_you_forget_pass']='Have you forgotten your password?';
$_LANG['L_email_reset_pass']="Please enter the email address used in my account, and you will receive an email containing a link to the change password";
$_LANG['l_e_mail']='E-mail';
$_LANG['l_send']='SEND';
$_LANG['l_bank']='BACK';
/*您的购物车中没有商品*/
$_LANG['l_cart_empty']='There is no commodity in your shopping cart.';
$_LANG['l_have_account']='Have the account?';
$_LANG['l_view_shopping_cart']='Check Cart';
$_LANG['l_checkout_immediately']='To check out';
$_LANG['l_log_in']='LOG IN';
$_LANG['l_not_account']='I have not registered any account.';
$_LANG['l_create_person_account']='Create a personal account for more exclusive privileges and rich experience.';
$_LANG['l_create_my_account']='Create my BOLON account';
$_LANG['l_member_login']='Member Login';
$_LANG['l_i_have_account']='I have an account already';
$_LANG['l_forget_pass']='Forgot password?';
$_LANG['l_register']='REGISTR';
$_LANG['l_now_register']='Now Register';
$_LANG['l_exclusive_membership_services']='Exclusive membership services.';
$_LANG['l_you_can']='You Can';
$_LANG['l_receive_our_newsletter']='Receive our newsletter';
$_LANG['l_save_your_favorite_products']='Save your favorite products';
$_LANG['l_more_convenient_payment_process']='More convenient payment process';
$_LANG['l_manage_your_order_and_return']='Manage your order and return';
$_LANG['l_confirm_password']='Confirm Password';
$_LANG['l_required']="Required";
$_LANG['l_immediate_registration']='Immediate registration';
$_LANG['l_favorite_brand']='Please choose your favorite brand, get the latest information on current events.';
$_LANG['l_all_brand']='All brand';
$_LANG['l_write_read']='I have read and agreed';
$_LANG['l_bolon_agree']='BOLON member registration agreement';
$_LANG['l_confirm']='Confirm';
$_LANG['l_filter']='Filter';
$_LANG['l_reset']="reset";
$_LANG['l_search']='Search...';
...
$_LANG['l_brand']="BRAND";
$_LANG['l_news']="NEWS";
$_LANG['l_submit']="Submit";
$_LANG['l_more']="MORE";

$_LANG['l_frame_material']="Frame material";
$_LANG['l_glass_material']="Glass material";
$_LANG['l_design_inspiration']="Design Inspiration";
$_LANG['l_size_specification']="Size Specification";
$_LANG['l_product_material']="Product Material";
$_LANG['l_size']=" length";
$_LANG['l_brand']="BRAND";
$_LANG['l_technology']="UNIQUE CARD SLOT TECHNOLOGY";
$_LANG['l_sunglasses']="Sun Glasses";
$_LANG['l_color']="Color:";
$_LANG['l_address']="Unit 1101, No.1 Nantou Road, Siming District, Xiamen, Fujian Province, China.";
$_LANG['l_company']="XIAMEN ARTGRI OPTICAL Co.,Ltd.";
$_LANG['l_telephone']="Tel:";
$_LANG['l_stoneshop']="Bolon Stone";
$_LANG['l_boutique']="Search By Boutique";
$_LANG['l_no_found']="Unfortunately, that match your search for products not found!";
$_LANG['l_together_searches']="together searches ";
$_LANG['l_product_c']="product";
?>