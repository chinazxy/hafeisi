...
}elseif ($_REQUEST['act'] == 'insert')
{
	...
	$addtime=time();
$sql = "INSERT INTO ".$GLOBALS['ecs']->table('desufb')."(title,entitle,url,descript,endescript,images,resort,addtime,isshow,thump_o,images_s,thump_o_s) ".
...
}elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('ur_here',       "DESUFB页面修改");
