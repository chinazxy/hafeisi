...
elseif (isset($_POST['Submit']))
{
   ...
   $orgimg=handle_upload_image($_FILES['ico_pay']);
   
   if(empty($orgimg)){
   
   $orgimg=$_POST['ico_pay_h'];
   }
    /* 取得配置信息 */
    $pay_config = array();
    ...
    else
    {
        ...
        else
        {
            ...
            $sql = "INSERT INTO " . $ecs->table('payment') . " (pay_code, pay_name, pay_desc,pay_icon, pay_config, is_cod, pay_fee, enabled, is_online)" .
                   "VALUES ('$_POST[pay_code]', '$_POST[pay_name]', '$_POST[pay_desc]','$orgimg', '$pay_config', '$_POST[is_cod]', '$pay_fee', 1, '$_POST[is_online]')";
...
//原图保r存
$orgImg=DATA_DIR . "/payment/".$filename;
