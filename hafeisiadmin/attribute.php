...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $attr = array(
		...
		'attr_envalues'     => isset($_POST['attr_envalues']) ? $_POST['attr_envalues'] : '',
		'attr_color'=> isset($_POST['attr_color']) ? $_POST['attr_color'] : '',
...
function get_attrlist()
{
    ...
    foreach ($row AS $key => $val)
    {
        $row[$key]['attr_input_type_desc'] = $GLOBALS['_LANG']['value_attr_input_type'][$val['attr_input_type']];
		 ...
		 $row[$key]['attr_envalues']      = str_replace("\n", ", ", $val['attr_envalues']);
		  $row[$key]['attr_color']      = str_replace("\n", ", ", $val['attr_color']);
