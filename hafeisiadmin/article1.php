...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('article')."(title,entitle, cat_id, article_type, is_open,is_show, author, ".
                "author_email, keywords, content, add_time, file_url, open_type, link, description,file_ulr_m,file_url_t,index_plot,month,fp_time,resort) ".
            "VALUES ('$_POST[title]', '$_POST[entitle]','$_POST[article_cat]', '$_POST[article_type]', '$_POST[is_open]','$_POST[is_show]', ".
                ...
                "'$add_time', '$file_url', '$open_type', '$_POST[link_url]', '$_POST[description]','$file_thump_m','$file_thump_t','$index_plot','$month','$fptime','$resort')";
    $db->query($sql);
...
if ($_REQUEST['act'] =='update')
{
    ...
    if ($exc->edit("title='$_POST[title]',entitle='$_POST[entitle]', cat_id='$_POST[article_cat]', article_type='$_POST[article_type]', is_open='$_POST[is_open]',is_show='$_POST[is_show]', author='$_POST[author]', author_email='$_POST[author_email]', keywords ='$_POST[keywords]', file_url ='$file_url', open_type='$open_type', content='$_POST[FCKeditor1]', link='$_POST[link_url]', description = '$_POST[description]',file_ulr_m='$file_thump_m',file_url_t='$file_thump_t',index_plot='$index_plot',fp_time='$fptime',resort='$resort'", $_POST['id']))
    {
...
function upload_article_index_plot($upload)
{
   ...
   $thumb_url = $image->make_thumb($upload['tmp_name'],300,200,ROOT_PATH. DATA_DIR .  "/article/");  
