...
$modules['01_home']['01_home_manger']       = 'home.php?act=list'; 
//$modules['01_home']['03_home_manger']       = 'book.php?act=list';
//$modules['01_home']['02_home_manger']       = 'push.php?act=list';
//$modules['01_home']['04_home_manger']       = 'videoim.php?act=list';  //视频图片管理
//$modules['01_home']['05_home_manger']       = 'gonyigg.php?act=list';//工艺广告图片管理
//$modules['01_home']['06_home_manger']       = 'desufb.php?act=list'; 
//$modules['01_home']['07_home_manger']       = 'menshop.php?act=list'; 
$modules['02_cat_and_goods']['01_goods_ad']       = 'goodsad.php?act=list';  
...
$modules['02_cat_and_goods']['05_fangwei']   = 'fangweiimport.php?act=import';
...
$modules['21_xinwen']['21_xinwen_ye']        = 'xinwen_p.php?act=list';
$modules['25_gwzs']['gwzs']             = 'gwzs.php?act=list';
...
$modules['04_order']['10_back_order']               = 'order.php?act=refund_list';
...
$modules['07_content']['01_znobrand']           = 'znobrand.php?act=list';
$modules['07_content']['01_zhishiku']           = 'zhishiku.php?act=list';
...
$modules['17_user_manage']['user_msg_manger']        = 'msg.php?act=list';


//$modules['19_sale_stone']['salestore']        ='salestone.php?act=list';
//$modules['18_service']['ts']        = 'ts.php?act=list&pid=1';

//$modules['18_service']['zx']        = 'zx.php?act=list&pid=0';

//$modules['18_service']['question']        = 'question.php?act=list&pid=1';

//$modules['18_service']['baoxiu']        = 'baoxiu.php?act=list';

$modules['21_brand']['21_brand_pinpai']        = 'brand_p.php?act=list';  //品牌



//$modules['21_technology']['21_technology_manger']        ='technology.php?act=list';

//$modules['21_answers']['01_answers_manger']       = 'answers.php?act=list';
$modules['08_members']['11_users_person_center']    = 'user_person.php?act=list';//会员中心菜单


/*$modules['22_dingzhi']['01_dingzhi_menu']       = 'dz.php?act=add';

$modules['22_dingzhi']['01_dingzhi_jp']       = 'dingzhi.php?act=list'; 
$modules['22_dingzhi']['18_glasses_pack']     ='glasses_case.php?act=list';
$modules['22_dingzhi']['01_dingzhi_jpglass']  ='jpcategory.php?act=list';

$modules['22_dingzhi']['18_dingzhi_chufan']     ='dingzhi_chufan.php?act=add';

$modules['22_dingzhi']['19_dingzhi_miaoshu']     ='dingzhi_miaoshu.php?act=list';*/
