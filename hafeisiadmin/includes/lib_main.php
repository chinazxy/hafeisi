 ...
 */
function create_html_editor($input_name, $input_value = '',$Width='100%',$height='320')
{
    global $smarty;
...
/*2015.04.15*/
function create_html_editor_lys($input_name, $input_value = '',$Width='100%',$height='320')
{
    global $smarty;
...
function create_html_editor2($input_name, $input_value = '')
{
    ...
    $editor->Value      = $input_value;
    $FCKeditor = $editor->CreateHtml();
    $smarty->assign('goods_size_des', $FCKeditor);
}
...
function create_html_editor3($input_name, $input_value = '')
{
    ...
    $editor->Value      = $input_value;
    $FCKeditor = $editor->CreateHtml();
    $smarty->assign('goods_size_endes', $FCKeditor);
}


function create_html_editor4($input_name, $input_value = '')
{
    global $smarty;
    ...
    $editor->Value      = $input_value;
    $FCKeditor = $editor->CreateHtml();
    $smarty->assign('goods_glass_des', $FCKeditor);
}


function create_html_editor5($input_name, $input_value = '')
{
    global $smarty;
    ...
    $editor->Value      = $input_value;
    $FCKeditor = $editor->CreateHtml();
    $smarty->assign('goods_glass_endes', $FCKeditor);
}


function create_html_editor6($input_name, $input_value = '')
{
    global $smarty;
    ...
    $editor->Value      = $input_value;
    $FCKeditor = $editor->CreateHtml();
    $smarty->assign('goods_good_des', $FCKeditor);
}

function create_html_editor7($input_name, $input_value = '')
{
    global $smarty;
    ...
    $editor->Value      = $input_value;
    $FCKeditor = $editor->CreateHtml();
    $smarty->assign('goods_good_endes', $FCKeditor);
}


function create_html_editor8($input_name, $input_value = '')
{
    global $smarty;
    ...
    $editor->Value      = $input_value;
    $FCKeditor = $editor->CreateHtml();
    $smarty->assign('goods_brief_FCK', $FCKeditor);
}
