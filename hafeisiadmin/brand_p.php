...
}elseif ($_REQUEST['act'] == 'insert')
{
	...
	$sql = "INSERT INTO ".$GLOBALS['ecs']->table('brand_p')."(title,content,offset_sudu,first_p,first_p_m,bkimage_p,bkimage_p_m,bkimage_s,bkimage_s_m,resort,addtime,isshow,position,theme_title,URL,hide,model,vi_url,vi_url1,vi_url2,tanchuan_p,tanchuan_p_m,tanchuan_s,tanchuan_s_m)".
            "VALUES ('$title','$content','$sudu','$first_p','$first_p_m','$bkimage_p','$bkimage_p_m','$bkimage_s','$bkimage_s_m','$ogv','$addtime','$isshow','$position','$theme_title','$url','$hide','$model','$vi_url','$vi_url1','$vi_url2','$tanchuan_p','$tanchuan_p_m','$tanchuan_s','$tanchuan_s_m')";
...
}elseif ($_REQUEST['act'] == 'query')
{
 ...
 if($_GET['din']=='f'){//判断是否电脑
	...
	$sql="Update  ".$ecs->table('brand_p')." SET first_p='',first_p_m='' where id=".$id;
...
if($_GET['din']=='s'){//判断是否手机
 ...
 if($_GET['din']=='tp'){//判断是否电脑弹窗图
	...
	$sql="Update  ".$ecs->table('brand_p')." SET tanchuan_p='',tanchuan_p_m='' where id=".$id;
 ...
 if($_GET['din']=='ts'){//判断是否电脑
	...
	$sql="Update  ".$ecs->table('brand_p')." SET tanchuan_s='',tanchuan_s_m='' where id=".$id;
