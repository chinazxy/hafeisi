...
listTable.removeDz = function(id,ids,ctype, cfm, opt)
{
  ...
  if (confirm(cfm))
  {
    ...
    var args = "act=" + opt + "&id=" + id +"&ids=" + ids +"&ctype=" + ctype + this.compileFilter();

    Ajax.call(this.url, args, this.listCallbackF, "POST", "JSON");
  }
}
