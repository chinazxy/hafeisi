...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('ur_here',    '轮皤图管理');
    $smarty->assign('action_link', array('text' =>'轮皤图添加', 'href' => 'home.php?act=add'));
...
}elseif ($_REQUEST['act'] == 'insert')
{
    ...
    handle_gallery_image($_FILES['file'],$_FILES['img2'],$_FILES['img3'],$title,$entitle,$descript,$endescript,$url,$linkname,$resort,$isshow);
...
}elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('action_link',   array('href' => 'home.php?act=list', 'text' =>'轮皤图列表'));
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    handle_update_gallery_image($id,$_FILES['file'],$_FILES['img2'],$_FILES['img3'],$title,$entitle,$descript,$endescript,$url,$linkname,$resort,$isshow);
   /* 记录管理员操作 */
...
$sql="Update  ".$ecs->table('lunbo')." SET thump_s='' where id=".$id;
...
$sql="Update  ".$ecs->table('lunbo')." SET thump_sx='' where id=".$id;
...
function handle_gallery_image($image_files,$image_fontfile,$image3,$image_title,$image_entitle,$image_des,$image_endes,$image_url,$linkname,$image_sort,$isshow)
...
$orgImg2=DATA_DIR . "/homead/".$filename;
...
$orgImg3=DATA_DIR . "/homead/".$filename;
...
$addtime=time();
$sql = "INSERT INTO ".$GLOBALS['ecs']->table('lunbo')."(title,entitle,descript,endescript,url,images,resort,addtime,isshow,thump_o,thump_s,thump_sx,model,vi_url1,vi_url2,vi_url3,linkname) ".
            "VALUES ('$imgtitle','$entitle','$descript','$endescript','$url','$orgImg','$imgresort','$addtime','$show','$thumb_url','$orgImg2','$orgImg3','$model','$vi_url1','$vi_url2','$vi_url3','$linkname')";
...
function handle_update_gallery_image($ids,$image_files,$image2,$image3,$image_title,$image_entitle,$image_des,$image_endes,$image_url,$linkname,$image_sort,$isshow)
