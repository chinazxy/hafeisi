(function(factory) {
    ...
    $.fn.jScrollPane = function(settings) {
        ...
        function JScrollPane(elem, s) {
            ...
            function initialise(s) {
                ...
                isMaintainingPositon, lastContentX, lastContentY, hasContainingSpaceChanged, originalScrollTop, originalScrollLeft, maintainAtBottom = false,
            ...
            function initMousewheel() {
                container.unbind(mwEvent).bind(mwEvent,
            ...
            function initKeyboardNav() {
                ...
                elem.attr('tabindex', 0).unbind('keydown.jsp keypress.jsp').bind('keydown.jsp',
                function(e) {
            ...
            function observeHash() {
                if (location.hash && location.hash.length > 1) {
                    var e, retryInt, hash = escape(location.hash.substr(1)) // hash must be escaped to prevent XSS
                    ;
                    try {
                        e = $('#' + hash + ', a[name="' + hash + '"]');
                    } catch(err) {
            ...
            function hijackInternalLinks() {
                ...
                $(document.body).delegate('a[href*=#]', 'click',
                function(event) {
        ...
        // Pluginifying code...
        settings = $.extend({},
        $.fn.jScrollPane.defaults, settings);
    ...
    $.fn.jScrollPane.defaults = {
        ...
        scrollPagePercent: 1 // Percent of visible area scrolled when pageUp/Down or track area pressed
    };
