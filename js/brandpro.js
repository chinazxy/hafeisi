 ...
 $(function(){
	  ...
	  if(classname=="attrs_category"){
	   ...
	   if(vals!=""){
	     category=vals;
	 	 ...
	 	 if(classname=="attrs_brand"){
	   var valsText=$(this).children().next().html();
	   $(".brandtitle").html(valsText);
	   if(vals!=""){
	     brand=vals;
	  }
  ...
  filterProduct(1,category,brand,minprice,maxprice,true);
  });
...
var nextpage=0;
  ...
  filterProduct(page,category,brand,minprice,maxprice,false);
  nextpage=page;
...
function filterProduct(page,category,brand_id,minprice,maxprice,pagechange=true){
