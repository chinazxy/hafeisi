...
function yzname(){
  ...
  if(name.Trim()===""){
   $(".submit_state").html("<span class='ti_error'>*名不能为空!</span>").show();
	return false;
  }
...
function yzsurname(){
  ...
  if(surname.Trim()===""){
   ...
   $(".submit_state").html("<span class='ti_error'>*姓不能为空!</span>").show();
	return false;
  }
...
function yzemail(){
  ...
  if(email.Trim()===""){
       $(".submit_state").hide();
   $(".submit_state").html("<span class='ti_error'>*邮箱不能为空！</span>").show();
    return false;
  }else{
...
function nemail(){
  ...
  if(n_email.Trim()===""){
   ...
   $(".submit_state").html("<span class='ti_error'>*新邮箱不能为空！</span>").show();
    return false;
  }else{
   ...
   $(".submit_state").html("<span class='ti_error'>*新邮箱格式不正确！</span>").show();
    return false;
   ...
   $(".submit_state").html("<span class='ti_error'>*新邮箱格式不正确！</span>").show();
    return false;
     ...
     if(c_email!==n_email){
	      ...
	      $(".submit_state").html("<span class='ti_error'>*两次输入邮件不一致!</span>").show();
     return false;
	 }else{
	    $(".submit_state").hide();
     return true;
...
if(x_password.Trim()===""){
   ...
   $(".submit_state").html('<span class="ti_error">*现有密码不能为空</span>').show();
    return false;
  }else{
  
  $(".submit_state").html('').hide();
  return true;
...
if(pass.Trim()===""){
   ...
   $(".pass_state").html('<span class="ti_error">*现有密码不能为空</span>').show();
    return false;
  }else{
  
  $(".pass_state").html('').hide();
  return true;
...
if(newpass.Trim()===""){
   ...
   $(".pass_state").html('<span class="ti_error">*新密码不能为空</span>').show();
    return false;
  }else{
   if(newpass.Trim().length<6){
   

   $(".pass_state").html('<span class="ti_error">*新密码不能少于 6 个字符</span>').show();
       return false;
   }else{
...
function yzComparePass(){
  ...
  if(confirmpass.Trim()===""){
   $(".pass_state").html('<span class="ti_error">*确认密码不能为空</span>').show();
       return false;
     ...
     if(confirmpass===newpass){
	  ...
	  $(".pass_state").html('<span class="ti_error">*两次输入密码不一致</span>').show();
	      return false;
	 }
