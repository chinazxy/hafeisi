...
$(function() {
    ...
    function initLeft() {
        ...
        $(".d_xunh,#scrollbar_l .viewport").css("height", windowH - $(".dingz_box2_h").height() - $(".dk_box4").height() - $(".dingz_box2_tj").outerHeight() - $(".ding_baocuo").outerHeight() - 31 - parseInt($(".dingz_box2_tj").css("marginTop")) - parseInt($(".dz_fx").css("marginTop")) - $(".ding_tishi").outerHeight() - $(".dz_fx").outerHeight() - $(".ding_baocuo").outerHeight() - 40)
    }
    initLeft();
    ...
    function reaiseBox() {
        ...
        if ($(window).width() < 1200) {
            ...
            $(".dingz_contain").css("width", "58%");
        } else {
            $(".dingz_contain").css("width", "65%");
        }
 ...
 showcf("请填写处方信息", "", "bcc");
    ...
    function cItem(ci, obj) {
        ...
        $(".scrollCs").animate({
            "width": $(window).width() - box2w - $(".dingz_box3").width()
        },
        500);
        ...
        if (jp_type == 1) {
            ...
            if ($(this).hasClass("c_l_eye_c")) {
                if ($(this).find("option:selected").val() != "" && $(".c_l_eye_a").find("option:selected").val() == "") {
                    $(".confirm_bcc").fadeIn().html("请选择左眼轴位！");
            ...
            if ($(this).hasClass("c_r_eye_c")) {
                if ($(this).find("option:selected").val() != "" && $(".c_r_eye_a").find("option:selected").val() == "") {
                    $(".confirm_bcc").fadeIn().html("请选择右眼轴位！");
            ...
            if ($(this).hasClass("c_l_eye_t")) {
                ...
                if ($(this).find("option:selected").text().Trim() == "" || $(this).find("option:selected").val() == "") {
                    $(".confirm_bcc").fadeIn().html("请选择左眼瞳距！");
            ...
            if ($(this).hasClass("c_r_eye_t")) {
                ...
                $(".c_pd_eye_t").html(pdvals);
                if ($(this).find("option:selected").text().Trim() == "" || $(this).find("option:selected").val() == "") {
                    $(".confirm_bcc").fadeIn().html("请选择右眼瞳距！");
    ...
    if ($(obj).hasClass("bl_mbox") || $(obj).hasClass("bl_mbox_cz")) {
        ...
        if ($(obj).hasClass("jt") || $(obj).hasClass("jtt")) {
            ...
            if ($(obj).hasClass("jp")) {
                ...
                if (jp_type == 1) {
				 $(".j_chuf2").not(".l_eye_a,.r_eye_a,.c_l_eye_a,.c_r_eye_a").removeAttr("disabled");
                    $(".js_show").show()
                } else {
				 $(".j_chuf2").attr("disabled","disabled");
                    $(".js_show").hide()
