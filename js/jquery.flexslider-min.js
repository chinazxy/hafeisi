...
(function(e) {
    e.flexslider = function(t, n) {
        ...
        v = {
            ...
            directionNav: {
                setup: function() {
                    var t = e('<div class="leftdiv "><span  class="flex-prev leimg"><img src="themes/default/images/zo.png" /></span></div> <div class="rightdiv"><span class="flex-next rigimg"><img src="themes/default/images/yo.png" /></span></div>');
                    if (r.controlsContainer) {
					    
                        e(r.controlsContainer).append(t);
                        r.directionNav = e("span", r.controlsContainer)
                    } else {
					
                        r.append(t);
                        r.directionNav = e("." + i + "direction-nav span", r)
                    }
        ...
        r.setProps = function(e, t, n) {
            ...
            if (r.transitions) {
			    ...
			    r.container.css("-" + r.pfx + "-transition-timing-function","ease-out-quart");
                r.container.css("-" + r.pfx + "-transition-duration", n);
			    r.container.css("transition-timing-function","ease-out-quart");
		...
		r.wordAnimate=function(i){
		 r.nums=i;
		 var tops=$('.worddiv .gt').eq(0).outerHeight();
		// $('.worddiv .gt').delay(300).eq(i).stop().animate({top:[0,"easeInOutSine"],opacity:1},500);
	
		   // r.lastIndex >= 0 && r.lastIndex <= $('.worddiv .gt').length - 1 && r.reset(r.lastIndex);
	      //  r.lastIndex=i;
			
       
		}
		r.reset=function(i){
		// $('.worddiv .gt').eq(i).stop().animate({top:[50,"easeInOutSine"],opacity:0},500);
